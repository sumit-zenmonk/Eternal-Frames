import { eventDataSource, options } from '../data-source';
...
async function create() {
    eventDataSource.setOptions({
        ...options,
    });

    await eventDataSource.initialize();

    const queryRunner = eventDataSource.createQueryRunner();
