...
export class outboxMigration1778505599999 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "event_schema"."outbox_status_enum" AS ENUM('pending','published','failed')`);
        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: "status", type: `"event_schema"."outbox_status_enum"`, default: `'pending'`, isNullable: false, },
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE IF EXISTS "event_schema"."outbox_status_enum"`);
    }
}